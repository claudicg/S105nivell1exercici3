...
public class ArbreDirectoriText {
	...
	public void escriureDirectoriTxt(String arxiuArbreDirectori) {

		WriterUtils.escriureArxius( arxiuArbreDirectori , "src/main/resources/Readme",
